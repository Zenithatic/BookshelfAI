...
function createModelManager() {
    ...
    const geminiModels = [
        ...
        new GoogleGenerativeAI(process.env.GEMINI_API_KEY5).getGenerativeModel({ model: "gemini-1.5-flash" }),
    ]
    ...
    const fileManagers = [
        ...
        new GoogleAIFileManager(process.env.GEMINI_API_KEY5),
    ]
