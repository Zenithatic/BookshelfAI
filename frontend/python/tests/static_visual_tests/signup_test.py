...
# function to make sure signup page is visually functional
def test_signup_visual():
    driver = init_driver()
    ...
    try:
        ...
        # test to see if get verify code button is rendered properly
        verify_code = driver.find_element(by=By.ID, value="getEmailCode")
        test7 = verify_code != None and verify_code.is_displayed() and verify_code.value_of_css_property("font-family") == "\"Afacad Flux\", system-ui"
