...
def test_nav_functionality():
    ...
    try:
        ...
        about_button = nav_bar_main.find_elements(by=By.CLASS_NAME, value="nav-btn")[1].click()
        driver.implicitly_wait(1)
        test1 = driver.current_url == "http://localhost/about/"

        # navigate to help page
        nav_bar_main = driver.find_element(by=By.CLASS_NAME, value="nav-bar-main")
        help_button = nav_bar_main.find_elements(by=By.CLASS_NAME, value="nav-btn")[2].click()
        driver.implicitly_wait(1)
        ...
        nav_bar_login = driver.find_element(by=By.CLASS_NAME, value="nav-bar-login")
        signup_button = nav_bar_login.find_elements(by=By.CLASS_NAME, value="nav-account")[1].click()
        driver.implicitly_wait(1)
